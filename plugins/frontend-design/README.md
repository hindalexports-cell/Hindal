...
## 🥭 Hindal Agri Exports Use Cases

Use this plugin to build beautiful trade UIs for Haroon's business:

```
"Build a daily market rate dashboard for mango, cumin, chickpea prices"
"Create a buyer CRM table with status indicators for Iran/UAE/Oman buyers"
"Design a shipment tracker card with document checklist progress bars"
"Build an export costing calculator with clean input form and USD output"
"Create a payment follow-up tracker with overdue alerts in red"
```
